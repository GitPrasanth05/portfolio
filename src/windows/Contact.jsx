        ...
        <div className="text-left space-y-2">
          <div className="flex items-center gap-2">
            ...
            <Copy
              ...
              onClick={() => {
                navigator.clipboard.writeText("9894510975");
                const k = document.getElementById("1i");
                if (k) {
                  k.classList.remove("hid");
                }
              }}
            />
            <span id="1i" className="hid text-green-500 font-bold">
              copied!
            </span>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <a href="mailto:prasanth09102005@gmail.com" className="mail">
            ...
            <Copy
              ...
              onClick={() => {
                ...
                const k = document.getElementById("2i");
                if (k) {
                  k.classList.remove("hid");
                }
              }}
            />
            <span id="2i" className="hid text-green-500 font-bold">
              copied!
            </span>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <a href="mailto:prasanth.m2023cce@sece.ac.in" className="mail">
            ...
            <Copy
              ...
              onClick={() => {
                ...
                const k = document.getElementById("3i");
                if (k) {
                  k.classList.remove("hid");
                }
                const g = document.getElementsById(copy3);
                if (g) {
                  g.classList.remove("text-gray-600");
                  g.classList.add("text-green-500 font-bold");
                }
              }}
            />
            <span id="3i" className="hid text-green-500 font-bold ">
              copied!
            </span>
          </div>
        </div>
